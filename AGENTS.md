...
## Passive Rule: Model Effort Policy (เนตรเลือกกำลัง)
- **ช่องแชทหลัก (Main Chat):** ใช้ model + effort ตามที่ท่านตั้งไว้เป็นค่าเริ่มต้น — ห้ามถามหรือเสนอเปลี่ยน model/effort เองระหว่างงานปกติ
- **งานหนัก/เสี่ยงสูง:** (auth, RLS/permission, custom OAuth, security-sensitive code, ระบบเงิน/การเงิน, รีวิวโค้ดก่อน merge, ดีบักบั๊กที่วนหลายรอบไม่จบ) → ให้เปิด subagent (หรือกลไกเทียบเท่า) แล้วเลือก model รุ่นสูงสุดพร้อม reasoning effort สูงสุดเอง โดยไม่ต้องถามท่านก่อน
- **เลื่อน effort ขึ้นชั่วคราว (Main Chat):** ทำได้เฉพาะกรณีดีบักบั๊กแปลกที่แก้ไม่จบ หรือตัดสินใจสเปกใหม่ที่ยังไม่เคย grill มาก่อน และเมื่อเสร็จงานให้เสนอเลื่อนกลับค่าเดิมทันที
- **หลักการ (Core Principle):** จ่าย model แรง/effort สูง เฉพาะจุดที่ผิดแล้วเจ็บเงียบๆ หรือคิดเชิงลึกจริง ส่วนงาน volume หรืองานที่ทำตามสเปกชัดเจนให้ใช้ตัวกลางพอ
