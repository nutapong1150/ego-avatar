...
- **แท็กกำลัง (จากสกิล `เนตรเลือกกำลัง`):** ต่อท้าย badge ด้วย `[⚡<model>-<effort>]` เฉพาะตอนที่เบิก model/effort สูงกว่าปกติ (เช่น เปิด subagent Opus effort สูงให้งานเสี่ยงสูง) — ตัวอย่าง: `[lineauth] [Kaiju Core] [T3: Complex] [⚡Opus-High]` ถ้าใช้ค่าปกติตามที่ท่านตั้งอยู่แล้ว **ไม่ต้องแปะแท็กนี้** (กันรก)
